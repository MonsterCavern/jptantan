...
namespace Illuminate\Support\Facades { 
    ...
    class Response {
        ...
        {
            return \Illuminate\Routing\ResponseFactory::caps($value);
        }
         ...
         * @static 
         */ 
        public static function jsonb($data, $status = 200, $message = array(), $headers = array(), $options = 256)
        {
            return \Illuminate\Routing\ResponseFactory::jsonb($data, $status, $message, $headers, $options);
        }
